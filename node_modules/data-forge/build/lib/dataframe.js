...
var DataFrame = /** @class */ (function () {
    ...
    */
    ...
    DataFrame.prototype.skip = function (numValues) {
        var _this = this;
        chai_1.assert.isNumber(numValues, "Expected 'numValues' parameter to 'DataFrame.skip' to be a number.");
        return new DataFrame(function () {
            var content = _this.getContent();
            return {
                columnNames: content.columnNames,
    ...
    DataFrame.prototype.any = function (predicate) {
        if (predicate) {
            chai_1.assert.isFunction(predicate, "Expected optional 'predicate' parameter to 'DataFrame.any' to be a function.");
        }
        if (predicate) {
            try {
